...
function ThankYouState({ rating, setShowThankYouState }: Props) {
  return (
    <div
      className="max-w-86 fixed mx-5 flex flex-col items-center gap-6 bg-grey-900 px-5 py-7 rounded-xl sm:px-7 sm:py-10 sm:max-w-90 sm:rounded-3xl"
      onClick={() => setShowThankYouState(false)}
    >
      <IllustrationThankYou width={162} height={108} />

      <p className="text-primary bg-grey-800 py-2 px-4 rounded-4xl w-fit">
